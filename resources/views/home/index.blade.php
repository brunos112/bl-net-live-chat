...
<head>
    ...
    <meta name="description" content="Powerful Group Chat">
    <!-- favicon -->
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <div class="feature-brief__heading">
                    {{ __('messages.blnet_chat_features') }}
                </div>
            ...
            <div class="col-12 col-md-6 d-flex feature-brief__img-wrapper">
                <img src="{{asset('assets/images/chat-landing2.png')}}" alt="{{ __('messages.blnet_chat_features') }}"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <h1 class="start-using-now__heading">{{ __('messages.start_using_blnetchat_now') }}</h1>
                        <p>{{ __('messages.start_using_blnetchat_now_desc') }}</p>
    ...
    <div class="footer__container container">
        <div class="row">
            <div class="col-md-6">
                ...
                <ul>
                    <li>
                        <a href="//twitter.com/blnet" target="_blank">{{ __('messages.twitter') }}</a>
                    </li>
                    <li>
                        <a href="//www.facebook.com/blnet" target="_blank">{{ __('messages.facebook') }}</a>
                    </li>
                    <li>
                        <a href="//in.linkedin.com/company/blnet-technologies"
                           target="_blank">{{ __('messages.linkedin') }}</a>
                    </li>
                    <li>
                        <a href="//github.com/BlNetLabs" target="_blank">{{ __('messages.github') }}</a>
                    </li>
                </ul>
            </div>
            <div class="col-md-6">
                <div>
                    <h4>{{ __('messages.made_with') }} <i class="fa fa-heart"
                                                          data-v-77d216a1=""></i> {{ __('messages.by_blnet_technologies') }}
                    </h4>
                    <p> {{ __('messages.by_blnet_technologies_desc') }} </p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="copyright text-center">
                    <p>Copyright © 2019. <a href="http://www.blnet.com/" target="_blank"><b>{{ getCompanyName() }}</b></a>
                    </p>
                </div>
            </div>
        </div>
